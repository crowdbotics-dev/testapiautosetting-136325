"""
Django settings for testapiautosetting_136325 project.
...
ROOT_URLCONF = 'testapiautosetting_136325.urls'
...
WSGI_APPLICATION = 'testapiautosetting_136325.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "TestAPIAutoSettingsb83n Support <support@testapiautosetting-136325.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapiautosetting_136325 API",
    "DESCRIPTION": "API documentation for testapiautosetting_136325 App",
    "VERSION": "v1",
}
